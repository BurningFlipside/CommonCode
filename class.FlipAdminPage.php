...
class FlipAdminPage extends FlipPage
{
    ...
    protected function addHeader()
    {
        ...
        $log     = '<a href="'.$this->profilesUrl.'/logout.php"><i class="fa fa-sign-out"></i></a>';
        if($this->user === false || $this->user === null)
        {
            $log = '<a href="'.$this->profilesUrl.'/login.php?return='.$this->currentUrl().'"><i class="fa fa-sign-in"></i></a>';
        }
